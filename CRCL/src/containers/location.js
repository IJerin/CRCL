...
export default class location extends Component {
  ...
  _showColorModal = () => this.setState({ isColorModalVisible: true });
        ...
        <View style={styles.slide2}>
          <View style={styles.container}>
            <View style={styles.rectangle}>
              ...
              <Text style={styles.text12}>No new users today</Text>
            </View>
            <View style={styles.triangleTopLeft} />
            <Image
              source={require("../Images/z2.png")}
              style={{ marginLeft: 235, marginBottom: -5, marginTop: 10 }}
            />
            <View style={styles.pic22}>
              <Image
                source={require("../Images/f1.png")}
                style={{ height: 92.5, width: 92.5 }}
              />
            </View>
            <Image
              source={require("../Images/e2.png")}
              style={{ marginLeft: 215, marginTop: -60 }}
            />
            <Image
              source={require("../Images/e2.png")}
              style={{ marginLeft: 178, marginTop: -7 }}
            />
            ...
            <Text style={styles.text42}>find other people around you</Text>
            <TouchableOpacity onPress={this.toDiscover}>
              <View style={styles.button3}>
                <Text style={styles.text52}>Enable</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
